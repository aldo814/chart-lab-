...
const businessData = [
  {
    ...
    title: "HTS 차트 솔루션",
    intro:
      "증권사·선물사·은행을 위한 데스크톱 기반 종합 차트 시스템을 구축합니다.",
    desc: [
    ...
    <div className="sub-business">
      <div className="inner">
        <div className="sub-business__intro">
          ...
          <p className="sub-business__desc">
            2011년 설립 이래, 차트연구소는 국내 주요 증권사·선물사·은행의
            HTS·MTS 차트 시스템을 만들어왔습니다. <br></br> 차트 엔진 설계부터
            분석 수식 DB, 사용자 인터페이스 구현, 납품 이후의 유지보수에
            이르기까지 — <br></br>금융 차트에 필요한 모든 영역을 자체 기술력으로
            설계하고 운영합니다.
          </p>
        </div>
            ...
            <div className="sub-business__item" key={item.id}>
              ...
              <div className="sub-business__content">
                <div className="sub-business__head">
                  ...
                  <span className="sub-business__desc">{item.intro}</span>
                </div>
