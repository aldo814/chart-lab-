...
import mtsIco01 from "../assets/images/main/ico_mts01.svg";
import mtsIco02 from "../assets/images/main/ico_mts02.svg";
import mtsIco03 from "../assets/images/main/ico_mts03.svg";
import mtsIco04 from "../assets/images/main/ico_mts04.svg";
...
function Main() {
  ...
  // Desktop uses the full-page container scroll. Mobile keeps normal document scroll.
  useEffect(() => {
    ...
    <div className="main-page" ref={mainPageRef}>
      ...
      <nav className={`fp-nav fp-nav--${sections[currentIdx].theme}`}>
        <ul className="fp-nav__list">
          {sections.map((sec, idx) => (
            <li
              key={idx}
              className={`fp-nav__item ${currentIdx === idx ? "fp-nav__item--active" : ""}`}
            >
              <button
                className="fp-nav__button"
                onClick={() => moveSection(idx)}
              >
      ...
      >
        <div className="hero-control">
          <span className="hero-control__current">
            {String(activeIndex).padStart(2, "0")}
          </span>
          <div className="hero-control__progress-wrap">
            <div className="hero-control__progress-bar" ref={progressBar}></div>
          </div>
          <span className="hero-control__total">
            {String(totalSlides).padStart(2, "0")}
          </span>
          <div className="hero-control__nav">
            <button className="hero-control__btn hero-control__btn--prev">
              이전
            </button>
            <button className="hero-control__btn hero-control__btn--next">
              다음
            </button>
            <button
        ...
        <Swiper
          ...
          navigation={{
            nextEl: ".hero-control__btn--next",
            prevEl: ".hero-control__btn--prev",
          }}
          onSwiper={(swiper) => {
            ...
            <div className="product-item__box">
              <div className="box-content">
                ...
                <ul className="ico-list">
                  ...
                  <li>
                    <i className="ico">
                      <img src={htsIco03} alt="" />
                    </i>
                    FastLight Drawing 기반 고성능 실시간 통합 차트
                  </li>
                  <li>
                    <i className="ico">
              ...
              <div className="box-hover">
                <div className="title">
                  <span className="en">power chart</span>
                  <h3 className="kr">파워차트 2.5 (HTS)</h3>
                </div>
                ...
                <Button variant="arrow-white" to="product/powerchart">
                  자세히보기
                </Button>
              </div>
            </div>
            ...
            <div className="product-item__box">
              ...
              <div className="box-hover">
                ...
                <ul className="dot-list">
                  ...
                  <li>
                    업계 최초 HTS ↔ MTS DB 및 속성 호환 / Android ↔ iOS 속성까지
                    호환
                  </li>
        ...
        <div className="partners__wrap">
          ...
          <div className="partners__row">
            <div className="partners__track partners__track--rtl">
              {[...partnerLogosReversed, ...partnerLogosReversed].map(
                (logo, i) => (
                  <div className="partners__item" key={i}>
                    <img src={logo.src} alt={logo.alt} />
                  </div>
